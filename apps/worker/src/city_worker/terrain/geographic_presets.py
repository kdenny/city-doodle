...
GEOGRAPHIC_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "bay_harbor": {
        "water_level": 0.38,
        "beach_enabled": True,
        "beach_height_band": 0.06,
        "bay_enabled": True,
        "bay_min_concavity_angle": 30.0,
        "bay_min_area": 600.0,
        "bay_max_depth_ratio": 4.0,
        "bay_harbor_min_area": 120000.0,
...
_VARIATION_RANGES: dict[str, tuple[float, float, float]] = {
    ...
    "beach_height_band": (0.04, 0.14, 0.15),
    "beach_slope_max": (0.08, 0.25, 0.15),
